	...
	class Member extends API {
		...
		public function memberData() {
			...
			if(mysql_num_rows($res) < 1) {
				$error = json_encode(array('status' => 'Failed', 'msg' => 'User does not exist'));
				$this->response($error, 409);
			}
			$array = mysql_fetch_array($res);
		...
		public function getFollowers() {
			...
			$res = mysql_query("SELECT f.followee_id,m.username FROM follows f,members m WHERE f.followee_id='$this->memberid' and m.member_id='$this->memberid'");
		...
		public function getFollowees() {
			...
			$res = mysql_query("SELECT f.followee_id,m.username FROM follows f,members m WHERE f.follower_id='$this->memberid' and m.member_id='$this->memberid'");
