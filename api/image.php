<?php
	...
	class Image extends API {
		...
		public function getImages() {
			...
			if($image_id != "")
				$res = mysql_query("SELECT *,(SELECT member_id FROM follows f,members m WHERE (m.member_id=f.follower_id and f.followee_id=i.owner_id and m.member_id='$this->memberid' and f.is_accepted=true and i.publicness < 2) or (m.member_id=i.owner_id and m.member_id='$this->memberid') or (i.publicness=0) LIMIT 1) AS cansee,(SELECT f.image_id FROM favorites f WHERE f.member_id='$this->memberid' and f.image_id=i.image_id LIMIT 1) AS isfavorite FROM images i WHERE i.image_id='$image_id' HAVING cansee!='NULL' ORDER BY i.image_id desc$limclause");
			else if($album_id != "")
				$res = mysql_query("SELECT *,(SELECT member_id FROM follows f,members m WHERE (m.member_id=f.follower_id and f.followee_id=i.owner_id and m.member_id='$this->memberid' and f.is_accepted=true and i.publicness < 2) or (m.member_id=i.owner_id and m.member_id='$this->memberid') or (i.publicness=0) LIMIT 1) AS cansee,(SELECT f.image_id FROM favorites f WHERE f.member_id='$this->memberid' and f.image_id=i.image_id LIMIT 1) AS isfavorite FROM images i WHERE i.album_id='$album_id' HAVING cansee!='NULL' ORDER BY i.image_id desc$limclause");
			else if($user_id != "")
				$res = mysql_query("SELECT *,(SELECT member_id FROM follows f,members m WHERE (m.member_id=f.follower_id and f.followee_id=i.owner_id and m.member_id='$this->memberid' and f.is_accepted=true and i.publicness < 2) or (m.member_id=i.owner_id and m.member_id='$this->memberid') or (i.publicness=0) LIMIT 1) AS cansee,(SELECT f.image_id FROM favorites f WHERE f.member_id='$this->memberid' and f.image_id=i.image_id LIMIT 1) AS isfavorite FROM images i WHERE i.owner_id='$user_id' HAVING cansee!='NULL' ORDER BY i.image_id desc$limclause");
			else if($tagged_user_id != "")
				$res = mysql_query("SELECT i.*,(SELECT member_id FROM follows f,members m WHERE (m.member_id=f.follower_id and f.followee_id=i.owner_id and m.member_id='$this->memberid' and f.is_accepted=true and i.publicness < 2) or (m.member_id=i.owner_id and m.member_id='$this->memberid') or (i.publicness=0) LIMIT 1) AS cansee,(SELECT f.image_id FROM favorites f WHERE f.member_id='$this->memberid' and f.image_id=i.image_id LIMIT 1) AS isfavorite FROM images i,mem_tags m WHERE m.member_id='$tagged_user_id' and m.image_id=i.image_id HAVING cansee!='NULL' ORDER BY i.image_id desc$limclause");
			else if($cat_id != "")
				$res = mysql_query("SELECT i.*,(SELECT member_id FROM follows f,members m WHERE (m.member_id=f.follower_id and f.followee_id=i.owner_id and m.member_id='$this->memberid' and f.is_accepted=true and i.publicness < 2) or (m.member_id=i.owner_id and m.member_id='$this->memberid') or (i.publicness=0) LIMIT 1) AS cansee,(SELECT f.image_id FROM favorites f WHERE f.member_id='$this->memberid' and f.image_id=i.image_id LIMIT 1) AS isfavorite FROM images i,category_tags c WHERE c.category_id='$cat_id' and c.image_id=i.image_id HAVING cansee!='NULL' ORDER BY i.image_id desc$limclause");
			else if($fuser_id != "")
				$res = mysql_query("SELECT i.*,(SELECT member_id FROM follows f,members m WHERE (m.member_id=f.follower_id and f.followee_id=i.owner_id and m.member_id='$this->memberid' and f.is_accepted=true and i.publicness < 2) or (m.member_id=i.owner_id and m.member_id='$this->memberid') or (i.publicness=0) LIMIT 1) AS cansee,(SELECT m.member_id FROM favorites v,members m WHERE m.member_id='$fuser_id' and v.member_id=m.member_id and v.image_id=i.image_id) AS isfavorite,(SELECT f.image_id FROM favorites f WHERE f.member_id='$this->memberid' and f.image_id=i.image_id LIMIT 1) AS isfavorite FROM images i HAVING cansee!='NULL' and isfavorite!='NULL' ORDER BY i.image_id desc$limclause");
			else
			...
			while($row = mysql_fetch_array($res)) {
					...
					$tosend[$i]['album_id'] = $row['album_id'];
